...
urlpatterns = [
    ...
    path(
        'password_change/', PasswordChangeView.as_view(
            ...
            success_url='done'), name='password_change_form'
    ),
    path(
        'password_reset/complete/', PasswordResetCompleteView.as_view(
    ...
    path(
        'reset/done/', PasswordResetDoneView.as_view(
    ...
    path(
        'password_reset/', PasswordResetView.as_view(
            ...
            success_url='done'), name='password_reset_form'
    )
]
